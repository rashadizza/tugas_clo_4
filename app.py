...
# Load data function
def load_data():
    data = yf.download("TLKM.JK", start="2021-01-01", end="2023-6-30")
...
st.write('Disusun Oleh Group 2')
st.write(
  """
  - M. Ariq Dhafin Rosyadi (1301210553)
  - Fadhlil Naufal Mahardian (1301213034)
  - Muhammad Naufal Thariq Ardian (1301213075)
  - Fatah Putra Purnama (1301210088)
  """
)
